                    ...
                    <div class="details_image">
                       ...
                       if(count($item->images) > 0){
                        ...
                        <div class="details_image_thumbnails d-flex flex-row align-items-start justify-content-between">
                            @if($image == 'product_4.jpg')
                            @else
                                @foreach($item->images as $img)
                                    @if($loop -> first)
                                        <div class="details_image_thumbnail active" data-image="images/{{$img['img']}}"><img src="/images/{{$img['img']}}" alt="{{$item->title}}"></div>
                                    @else
                                        <div class="details_image_thumbnail" data-image="images/{{$image}}"><img src="/images/{{$img['img']}}" alt="{{$item->title}}"></div>
                                    @endif
                                @endforeach
                            @endif
                ...
                <div class="col-lg-6">
                    <div class="details_content">
                        ...
                        @if($item ->new_price != null)
                            <div clsaa = "details_discount" >${{$item->price}}</div>
                    ...
                    <!-- In Stock -->
                        ...
                        <div class="product_quantity_container">
                            ...
                            <div class="button cart_button"><a href="{{route('addCart', ['id' => $item -> id])}}">Add to cart</a></div>
                        </div>
